...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        albums.get(0).addToPlaylist("My Friends", playList); //already exist
        albums.get(0).addToPlaylist("Aeroplane", playList);
        albums.get(0).addToPlaylist("Dark Road", playList); //does not exist
        albums.get(0).addToPlaylist(9, playList);
        albums.get(1).addToPlaylist(7, playList);
        albums.get(1).addToPlaylist(3, playList);
        albums.get(1).addToPlaylist(1, playList);
        albums.get(1).addToPlaylist(17, playList); //does not have a track no
